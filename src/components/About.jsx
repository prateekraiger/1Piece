  ...
  return (
    ...
    >
      <div className="relative mb-8 mt-36 flex flex-col items-center gap-5 px-4 sm:px-8">
        <p className="font-general text-lg uppercase tracking-widest text-red-400/90 md:text-xl">
        ...
        <AnimatedTitle
          ...
          textClass="!text-4xl sm:!text-5xl md:!text-6xl bg-gradient-to-r from-amber-400 to-red-500 bg-clip-text text-transparent"
        />

        <div className="about-subtext max-w-3xl text-center">
          <p className="text-lg font-medium text-gray-200/90 md:text-xl">
            The world of{" "}
            <span className="text-red-400 hover:text-amber-400 transition-colors cursor-pointer">
              One Piece
            </span>{" "}
          ...
          <p className="mt-4 text-gray-400/90 md:text-lg">
            Follow <b className="text-amber-300">Monkey D. Luffy</b> and the
            Straw Hat Pirates as they navigate unpredictable waters, battle
            formidable foes, and chase their destiny beneath the banner of the
            <span className="text-red-400 mx-2">🏴‍☠️</span> Jolly Roger.
          </p>
        </div>
      </div>
      ...
      <div className="h-dvh w-screen" id="clip">
        <div className="mask-clip-path about-image relative overflow-hidden border-2 border-amber-400/20 shadow-2xl shadow-amber-900/30">
          ...
          <video
            ...
            loop
            muted
            className="absolute left-0 top-0 size-full object-cover brightness-110 contrast-125 saturate-[1.4]"
          />

          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/60 to-black/90" />

          <div className="content-overlay absolute bottom-0 left-0 right-0 p-8 text-center">
            <p className="text-2xl font-bold text-amber-400/90 sm:text-3xl md:text-4xl">
              "The One Piece... IS REAL!"
            </p>
            <p className="mt-2 text-gray-300/80 md:text-lg">
